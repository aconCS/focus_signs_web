...
export default function AboutPage() {
  ...
  const workshopPhotos = [
    { src: "/photos/work.jpg", alt: t("imageBrief"), span: "sm:col-span-2 sm:row-span-2" },
    { src: "/photos/van.jpg", alt: t("workshopTitle"), span: "" },
    { src: "/photos/road-signs.jpg", alt: t("workshopTitle"), span: "" },
    { src: "/photos/papantoniou-led.jpg", alt: t("workshopTitle"), span: "sm:col-span-2" },
  ];
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-24 lg:px-10 lg:py-32">
        <Reveal className="grid gap-14 lg:grid-cols-2 lg:items-center">
          <div className="min-h-[280px]">
            <Photo
              src="/photos/papantoniou-led.jpg"
